...
\begin{tikzpicture}[scale=1]
  ...
  % --- Generatore 2 (lato destro, + in alto) ---
  \generatore[0]{6}{1.5}{}

  % --- Resistore R1 (lato superiore) ---
  \resistoreANSI[0]{3}{3}{}
  \node[below] at (3,2.7) {\(R_1\)};

  % --- Resistore R2 (lato inferiore) ---
  \resistoreANSI[0]{3}{0}{}
  \node[below] at (3,0.9) {\(R_2\)};
  ...
  \node[green!60!black] at (3,1.4) {verso orario};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[scale=1]
  ...
  % Resistore R1
  \resistoreANSI{2}{4}{}
  \draw node[above] at (2,4.3) {\(R_1\)};
  % Filo dal resistore al lato destro
  \draw[thick] (3,4) -- (4,4);
  % Filo destro fino al resistore R2
  \draw[thick] (4,4) -- (4,3);
  % Resistore R2 (verticale, rotazione 90)
  \resistoreANSI[90]{4}{2}{}
  \draw node[left] at (3.7,2) {\(R_2\)};
  % Filo dal resistore al basso
  \draw[thick] (4,1) -- (4,0);
  % Filo inferiore
  \draw[thick] (4,0) -- (0,0);
  % Massa sul filo inferiore
  \massa{4}{0}
...
\begin{tikzpicture}[scale=1]
  ...
  \draw[thick] (0,0) -- (0,1);
  \generatore{0}{2}{}
  \node[left] at (-0.7,2) {\(V_{\text{in}}\)};
  \draw[thick] (0,3) -- (0,4);

  % Ramo con R1 (verticale, x=2)
  \draw[thick] (2,4) -- (2,3);
  \resistoreANSI[90]{2}{2}{}
  \node[right] at (2.4,2) {\(R_1\)};
  \draw[thick] (2,1) -- (2,0);

  % Ramo con R2 (verticale, x=4)
  \draw[thick] (4,4) -- (4,3);
  \resistoreANSI[90]{4}{2}{}
  \node[right] at (4.4,2) {\(R_2\)};
  \draw[thick] (4,1) -- (4,0);
